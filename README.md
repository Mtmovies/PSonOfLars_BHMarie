...
class Development(Config):
    OWNER_ID = 725093945  # my telegram ID
    OWNER_USERNAME = "DwayneJohnsonn"  # my telegram username
    API_KEY = "890182996:AAErZtuRF2CwdEDHQq4YJcSLyVNlAEda8Qw"  # my api key, as provided by the botfather
    SQLALCHEMY_DATABASE_URI = 'postgresql://username:password@localhost:5432/database'  # sample db credentials
    MESSAGE_DUMP = '-1234567890' # some group chat that your bot is a member of
    USE_MESSAGE_DUMP = True
    SUDO_USERS = [610796198,725093945]  # List of id's for users which have sudo access to the bot.
    LOAD = []
    NO_LOAD = ['translation']
```
